...
class IOSAssetLoader : AssetLoader {
    ...
    override suspend fun loadJsonFile(path: String): String? = withContext(Dispatchers.Default) {
        try {
            ...
            val fileURL = NSBundle.mainBundle.URLForResource(fileName, withExtension = null)
                ?: return@withContext null
            NSString.stringWithContentsOfURL(fileURL, encoding = NSUTF8StringEncoding, error = null) as String
        } catch (e: Exception) {
